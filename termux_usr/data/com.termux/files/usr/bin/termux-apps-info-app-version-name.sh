...
- https://github.com/termux/termux-core-package/blob/master/app/main/scripts/termux/shell/command/environment/termux-apps-info-app-version-name.sh.in
- https://github.com/termux/termux-packages/blob/master/packages/termux-core/app/main/scripts/termux/shell/command/environment/termux_core__sh__termux_apps_info_app_version_name
.
...
termux_core__sh__termux_apps_info_app_version_name__main() {
    ...
    if [ "$1" = "-h" ] || [ "$1" = "--help" ]; then
        ...
        echo "termux-apps-info-app-version-name.sh version=0.3.0 org=termux project=termux-core-package"; return $?
        return 0
